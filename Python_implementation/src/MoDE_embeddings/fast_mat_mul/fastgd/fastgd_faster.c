...
#define __PYX_HAVE__fastgd__fastgd_faster
#define __PYX_HAVE_API__fastgd__fastgd_faster
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'fastgd.fastgd_faster' */
...
static int __pyx_f_6fastgd_13fastgd_faster_mat_mult(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, double *, double *); /*proto*/
static int __pyx_f_6fastgd_13fastgd_faster_proj_l_u(double *, __Pyx_memviewslice, __Pyx_memviewslice); /*proto*/
static int __pyx_f_6fastgd_13fastgd_faster_comp_grad(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, double *, __Pyx_memviewslice, __Pyx_memviewslice, double *); /*proto*/
static double *__pyx_f_6fastgd_13fastgd_faster_gd_routine(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, double, long, double, PyBoolObject *, long); /*proto*/
...
#define __Pyx_MODULE_NAME "fastgd.fastgd_faster"
extern int __pyx_module_is_main_fastgd__fastgd_faster;
int __pyx_module_is_main_fastgd__fastgd_faster = 0;

/* Implementation of 'fastgd.fastgd_faster' */
...
static const char __pyx_k_fastgd_fastgd_faster[] = "fastgd.fastgd_faster";
...
static const char __pyx_k_fastgd_fastgd_faster_pyx[] = "fastgd/fastgd_faster.pyx";
...
static PyObject *__pyx_n_s_fastgd_fastgd_faster;
static PyObject *__pyx_kp_s_fastgd_fastgd_faster_pyx;
...
static PyObject *__pyx_pf_6fastgd_13fastgd_faster_gd(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_inc_mat, long __pyx_v_N, __Pyx_memviewslice __pyx_v_r_lb, __Pyx_memviewslice __pyx_v_r_ub, double __pyx_v_gamma, long __pyx_v_max_iter, PyBoolObject *__pyx_v_verbose, double __pyx_v_tol); /* proto */
...
static int __pyx_f_6fastgd_13fastgd_faster_mat_mult(__Pyx_memviewslice __pyx_v_m_data, __Pyx_memviewslice __pyx_v_m_indices, __Pyx_memviewslice __pyx_v_m_indptr, double *__pyx_v_vec, double *__pyx_v_res) {
 ...
 */
  {
      ...
      #endif
      /*try:*/ {
        if (unlikely(!__pyx_v_m_indptr.memview)) { __Pyx_RaiseUnboundMemoryviewSliceNogil("m_indptr"); __PYX_ERR(0, 23, __pyx_L4_error) }
        __pyx_t_1 = ((__pyx_v_m_indptr.shape[0]) - 1);
        if ((1 == 0)) abort();
        {
 ...
 */
                            (__pyx_v_res[__pyx_v_i]) = 0.0;

                            /* "fastgd/fastgd_faster.pyx":25
 *     for i in prange(m_indptr.shape[0]-1, nogil=True):
 *         res[i] = 0
 *         for j in range(m_indptr[i], m_indptr[i+1]):             # <<<<<<<<<<<<<<
 *             res[i] += m_data[j] * vec[m_indices[j]]
 ...
 */
                            ...
                            __pyx_t_5 = (*((int *) ( /* dim=0 */ (__pyx_v_m_indptr.data + __pyx_t_4 * __pyx_v_m_indptr.strides[0]) )));
                            __pyx_t_4 = __pyx_v_i;
                            __pyx_t_6 = __pyx_t_5;
                            for (__pyx_t_7 = (*((int *) ( /* dim=0 */ (__pyx_v_m_indptr.data + __pyx_t_4 * __pyx_v_m_indptr.strides[0]) ))); __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
                              __pyx_v_j = __pyx_t_7;

                              /* "fastgd/fastgd_faster.pyx":26
 *         res[i] = 0
 *         for j in range(m_indptr[i], m_indptr[i+1]):
 *             res[i] += m_data[j] * vec[m_indices[j]]             # <<<<<<<<<<<<<<
 *     return 1
 ...
 */
                              ...
                              (__pyx_v_res[__pyx_t_8]) = ((__pyx_v_res[__pyx_t_8]) + ((*((long *) ( /* dim=0 */ (__pyx_v_m_data.data + __pyx_t_9 * __pyx_v_m_data.strides[0]) ))) * (__pyx_v_vec[(*((int *) ( /* dim=0 */ (__pyx_v_m_indices.data + __pyx_t_10 * __pyx_v_m_indices.strides[0]) )))])));
                            }
                        }
                    }
                }
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("fastgd.fastgd_faster.mat_mult", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_r = 0;
  __pyx_L0:;
...
static int __pyx_f_6fastgd_13fastgd_faster_proj_l_u(double *__pyx_v_vec, __Pyx_memviewslice __pyx_v_l, __Pyx_memviewslice __pyx_v_u) {
  double __pyx_v_temp;
  Py_ssize_t __pyx_v_i;
  int __pyx_r;
  __Pyx_RefNannyDeclarations
 ...
 */
    __pyx_t_4 = __pyx_v_i;
    __pyx_t_5 = (*((double *) ( /* dim=0 */ (__pyx_v_u.data + __pyx_t_4 * __pyx_v_u.strides[0]) )));
    __pyx_t_6 = (__pyx_v_vec[__pyx_v_i]);
 ...
 */
    __pyx_t_8 = __pyx_v_i;
    __pyx_t_4 = __pyx_v_i;
    __pyx_t_7 = (*((double *) ( /* dim=0 */ (__pyx_v_l.data + __pyx_t_4 * __pyx_v_l.strides[0]) )));
    ...
    (__pyx_v_vec[__pyx_t_8]) = ((__pyx_v_vec[__pyx_t_8]) - __pyx_t_6);
  }

  /* "fastgd/fastgd_faster.pyx":37
 *         temp = min(vec[i], u[i])
 *         vec[i] -= max(temp, l[i])
 *     return 1             # <<<<<<<<<<<<<<
 * 
...
static int __pyx_f_6fastgd_13fastgd_faster_comp_grad(__Pyx_memviewslice __pyx_v_inc_mat_data, __Pyx_memviewslice __pyx_v_inc_mat_indices, __Pyx_memviewslice __pyx_v_inc_mat_indptr, __Pyx_memviewslice __pyx_v_inc_mat_tr_data, __Pyx_memviewslice __pyx_v_inc_mat_tr_indices, __Pyx_memviewslice __pyx_v_inc_mat_tr_indptr, double *__pyx_v_x, __Pyx_memviewslice __pyx_v_r_lb, __Pyx_memviewslice __pyx_v_r_ub, double *__pyx_v_grad) {
  long __pyx_v_N;
  double *__pyx_v_Ax;
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("comp_grad", 0);

  /* "fastgd/fastgd_faster.pyx":51
 *                 double* grad):
 * 
 ...
 */
  __pyx_v_N = ((__pyx_v_inc_mat_indptr.shape[0]) - 1);

  /* "fastgd/fastgd_faster.pyx":52
 * 
 *     cdef long N = inc_mat_indptr.shape[0] - 1
 *     cdef double* Ax = <double*> malloc(sizeof(double)* N)             # <<<<<<<<<<<<<<
 *     mat_mult(inc_mat_data, inc_mat_indices, inc_mat_indptr, x, Ax)
 ...
 */
  __pyx_v_Ax = ((double *)malloc(((sizeof(double)) * __pyx_v_N)));

  /* "fastgd/fastgd_faster.pyx":53
 *     cdef long N = inc_mat_indptr.shape[0] - 1
 *     cdef double* Ax = <double*> malloc(sizeof(double)* N)
 *     mat_mult(inc_mat_data, inc_mat_indices, inc_mat_indptr, x, Ax)             # <<<<<<<<<<<<<<
 *     proj_l_u(Ax, r_lb, r_ub)
 ...
 */
  (void)(__pyx_f_6fastgd_13fastgd_faster_mat_mult(__pyx_v_inc_mat_data, __pyx_v_inc_mat_indices, __pyx_v_inc_mat_indptr, __pyx_v_x, __pyx_v_Ax));

  /* "fastgd/fastgd_faster.pyx":54
 *     cdef double* Ax = <double*> malloc(sizeof(double)* N)
 *     mat_mult(inc_mat_data, inc_mat_indices, inc_mat_indptr, x, Ax)
 *     proj_l_u(Ax, r_lb, r_ub)             # <<<<<<<<<<<<<<
 *     mat_mult(inc_mat_tr_data, inc_mat_tr_indices, inc_mat_tr_indptr, Ax, grad)
 *     free(Ax)
 */
  (void)(__pyx_f_6fastgd_13fastgd_faster_proj_l_u(__pyx_v_Ax, __pyx_v_r_lb, __pyx_v_r_ub));

  /* "fastgd/fastgd_faster.pyx":55
 *     mat_mult(inc_mat_data, inc_mat_indices, inc_mat_indptr, x, Ax)
 *     proj_l_u(Ax, r_lb, r_ub)
 *     mat_mult(inc_mat_tr_data, inc_mat_tr_indices, inc_mat_tr_indptr, Ax, grad)             # <<<<<<<<<<<<<<
 *     free(Ax)
 *     return 1
 */
  (void)(__pyx_f_6fastgd_13fastgd_faster_mat_mult(__pyx_v_inc_mat_tr_data, __pyx_v_inc_mat_tr_indices, __pyx_v_inc_mat_tr_indptr, __pyx_v_Ax, __pyx_v_grad));

  /* "fastgd/fastgd_faster.pyx":56
 *     proj_l_u(Ax, r_lb, r_ub)
 *     mat_mult(inc_mat_tr_data, inc_mat_tr_indices, inc_mat_tr_indptr, Ax, grad)
 *     free(Ax)             # <<<<<<<<<<<<<<
 *     return 1
...
static double *__pyx_f_6fastgd_13fastgd_faster_gd_routine(__Pyx_memviewslice __pyx_v_inc_mat_data, __Pyx_memviewslice __pyx_v_inc_mat_indices, __Pyx_memviewslice __pyx_v_inc_mat_indptr, __Pyx_memviewslice __pyx_v_inc_mat_tr_data, __Pyx_memviewslice __pyx_v_inc_mat_tr_indices, __Pyx_memviewslice __pyx_v_inc_mat_tr_indptr, __Pyx_memviewslice __pyx_v_r_lb, __Pyx_memviewslice __pyx_v_r_ub, double __pyx_v_gamma, long __pyx_v_max_iter, double __pyx_v_tol, CYTHON_UNUSED PyBoolObject *__pyx_v_verbose, long __pyx_v_N) {
  CYTHON_UNUSED long __pyx_v_cnt;
  double *__pyx_v_grad;
  double *__pyx_v_x;
  long __pyx_v_i;
  double __pyx_v_grad_norm;
  double *__pyx_r;
  __Pyx_RefNannyDeclarations
  long __pyx_t_1;
  long __pyx_t_2;
  ...
  int __pyx_t_7;
  long __pyx_t_8;
  __Pyx_RefNannySetupContext("gd_routine", 0);

  /* "fastgd/fastgd_faster.pyx":76
 * 
 *     cdef long cnt
 ...
 * 
 */
  __pyx_v_grad = ((double *)malloc(((sizeof(double)) * (__pyx_v_N - 1))));

  /* "fastgd/fastgd_faster.pyx":77
 *     cdef long cnt
 *     cdef double* grad = <double*> malloc(sizeof(double)* (N-1))
 *     cdef double* x = <double*> malloc(sizeof(double) * (N-1))             # <<<<<<<<<<<<<<
 * 
 *     cdef long i
 */
  __pyx_v_x = ((double *)malloc(((sizeof(double)) * (__pyx_v_N - 1))));

  /* "fastgd/fastgd_faster.pyx":81
 *     cdef long i
 *     cdef :
 *         double grad_norm = 0             # <<<<<<<<<<<<<<
 *         double error
 * 
 */
  __pyx_v_grad_norm = 0.0;

  /* "fastgd/fastgd_faster.pyx":85
 * 
 *     # Initialize x
 *     for i in range(N-1):             # <<<<<<<<<<<<<<
 *         x[i] = 0
 ...
 *                   inc_mat_indptr,
 */
    (void)(__pyx_f_6fastgd_13fastgd_faster_comp_grad(__pyx_v_inc_mat_data, __pyx_v_inc_mat_indices, __pyx_v_inc_mat_indptr, __pyx_v_inc_mat_tr_data, __pyx_v_inc_mat_tr_indices, __pyx_v_inc_mat_tr_indptr, __pyx_v_x, __pyx_v_r_lb, __pyx_v_r_ub, __pyx_v_grad));

    /* "fastgd/fastgd_faster.pyx":100
 *                   grad)
 * 
 *         grad_norm = 0             # <<<<<<<<<<<<<<
 *         for i in range(N-1):
 ...
 */
      __pyx_v_grad_norm = (__pyx_v_grad_norm + ((__pyx_v_grad[__pyx_v_i]) * (__pyx_v_grad[__pyx_v_i])));
    }

    /* "fastgd/fastgd_faster.pyx":104
 *             grad_norm += grad[i] * grad[i]
 * 
 *         if grad_norm/(N-1) < tol*tol:             # <<<<<<<<<<<<<<
 *             free(grad)
 *             return x
 */
    __pyx_t_7 = (((__pyx_v_grad_norm / (__pyx_v_N - 1)) < (__pyx_v_tol * __pyx_v_tol)) != 0);
    if (__pyx_t_7) {

      /* "fastgd/fastgd_faster.pyx":105
 * 
 *         if grad_norm/(N-1) < tol*tol:
 *             free(grad)             # <<<<<<<<<<<<<<
 *             return x
 ...
 */
      __pyx_t_8 = __pyx_v_i;
      (__pyx_v_x[__pyx_t_8]) = ((__pyx_v_x[__pyx_t_8]) - (__pyx_v_gamma * (__pyx_v_grad[__pyx_v_i])));
    }
  }

  /* "fastgd/fastgd_faster.pyx":111
 *             x[i] -= gamma * grad[i]
 * 
 *     free(grad)             # <<<<<<<<<<<<<<
 *     return x
...
/* Python wrapper */
static PyObject *__pyx_pw_6fastgd_13fastgd_faster_1gd(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_6fastgd_13fastgd_faster_1gd = {"gd", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_6fastgd_13fastgd_faster_1gd, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_6fastgd_13fastgd_faster_1gd(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("gd (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_N)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("gd", 1, 8, 8, 1); __PYX_ERR(0, 114, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_r_lb)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("gd", 1, 8, 8, 2); __PYX_ERR(0, 114, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_r_ub)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("gd", 1, 8, 8, 3); __PYX_ERR(0, 114, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_gamma)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("gd", 1, 8, 8, 4); __PYX_ERR(0, 114, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_max_iter)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("gd", 1, 8, 8, 5); __PYX_ERR(0, 114, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_verbose)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("gd", 1, 8, 8, 6); __PYX_ERR(0, 114, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  7:
        if (likely((values[7] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_tol)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("gd", 1, 8, 8, 7); __PYX_ERR(0, 114, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "gd") < 0)) __PYX_ERR(0, 114, __pyx_L3_error)
      }
    ...
    __pyx_v_N = __Pyx_PyInt_As_long(values[1]); if (unlikely((__pyx_v_N == (long)-1) && PyErr_Occurred())) __PYX_ERR(0, 114, __pyx_L3_error)
    __pyx_v_r_lb = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_r_lb.memview)) __PYX_ERR(0, 114, __pyx_L3_error)
    __pyx_v_r_ub = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[3], PyBUF_WRITABLE); if (unlikely(!__pyx_v_r_ub.memview)) __PYX_ERR(0, 114, __pyx_L3_error)
    __pyx_v_gamma = __pyx_PyFloat_AsDouble(values[4]); if (unlikely((__pyx_v_gamma == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 114, __pyx_L3_error)
    __pyx_v_max_iter = __Pyx_PyInt_As_long(values[5]); if (unlikely((__pyx_v_max_iter == (long)-1) && PyErr_Occurred())) __PYX_ERR(0, 114, __pyx_L3_error)
    __pyx_v_verbose = ((PyBoolObject *)values[6]);
    __pyx_v_tol = __pyx_PyFloat_AsDouble(values[7]); if (unlikely((__pyx_v_tol == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 114, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("gd", 1, 8, 8, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 114, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("fastgd.fastgd_faster.gd", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_verbose), __pyx_ptype_7cpython_4bool_bool, 1, "verbose", 0))) __PYX_ERR(0, 114, __pyx_L1_error)
  __pyx_r = __pyx_pf_6fastgd_13fastgd_faster_gd(__pyx_self, __pyx_v_inc_mat, __pyx_v_N, __pyx_v_r_lb, __pyx_v_r_ub, __pyx_v_gamma, __pyx_v_max_iter, __pyx_v_verbose, __pyx_v_tol);
...
static PyObject *__pyx_pf_6fastgd_13fastgd_faster_gd(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_inc_mat, long __pyx_v_N, __Pyx_memviewslice __pyx_v_r_lb, __Pyx_memviewslice __pyx_v_r_ub, double __pyx_v_gamma, long __pyx_v_max_iter, PyBoolObject *__pyx_v_verbose, double __pyx_v_tol) {
 ...
 */
  __Pyx_GetModuleGlobalName(__pyx_t_2, __pyx_n_s_sparse); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 119, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_csr_matrix); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 119, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_v_inc_mat, __pyx_n_s_T); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 119, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_4 = NULL;
 ...
 *     for i in range(N-1):
 */
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_inc_mat, __pyx_n_s_data); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 120, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_5 = __Pyx_PyObject_to_MemoryviewSlice_ds_long(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_5.memview)) __PYX_ERR(0, 120, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_inc_mat, __pyx_n_s_indices); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 120, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_ds_int(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 120, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_inc_mat, __pyx_n_s_indptr); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 120, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_7 = __Pyx_PyObject_to_MemoryviewSlice_ds_int(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_7.memview)) __PYX_ERR(0, 120, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_inc_mat_tr, __pyx_n_s_data); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 120, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_8 = __Pyx_PyObject_to_MemoryviewSlice_ds_long(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_8.memview)) __PYX_ERR(0, 120, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_inc_mat_tr, __pyx_n_s_indices); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 120, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_9 = __Pyx_PyObject_to_MemoryviewSlice_ds_int(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_9.memview)) __PYX_ERR(0, 120, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_inc_mat_tr, __pyx_n_s_indptr); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 120, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_10 = __Pyx_PyObject_to_MemoryviewSlice_ds_int(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_10.memview)) __PYX_ERR(0, 120, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_x = __pyx_f_6fastgd_13fastgd_faster_gd_routine(__pyx_t_5, __pyx_t_6, __pyx_t_7, __pyx_t_8, __pyx_t_9, __pyx_t_10, __pyx_v_r_lb, __pyx_v_r_ub, __pyx_v_gamma, __pyx_v_max_iter, __pyx_v_tol, __pyx_v_verbose, __pyx_v_N);
 ...
 */
  ...
  __pyx_t_11 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_double); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 121, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_11);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  if (PyDict_SetItem(__pyx_t_1, __pyx_n_s_dtype, __pyx_t_11) < 0) __PYX_ERR(0, 121, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
  __pyx_t_11 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_t_2, __pyx_t_1); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 121, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_11);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_x_arr = __pyx_t_11;
  __pyx_t_11 = 0;

  /* "fastgd/fastgd_faster.pyx":122
 *     x = gd_routine(inc_mat.data, inc_mat.indices, inc_mat.indptr, inc_mat_tr.data, inc_mat_tr.indices, inc_mat_tr.indptr, r_lb, r_ub, gamma, max_iter, tol, verbose, N)
 *     x_arr = np.zeros(N-1, dtype = np.double)
 *     for i in range(N-1):             # <<<<<<<<<<<<<<
 *         x_arr[i] = x[i]
 ...
 * 
 */
    __pyx_t_11 = PyFloat_FromDouble((__pyx_v_x[__pyx_v_i])); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 123, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_11);
    if (unlikely(__Pyx_SetItemInt(__pyx_v_x_arr, __pyx_v_i, __pyx_t_11, long, 1, __Pyx_PyInt_From_long, 0, 0, 0) < 0)) __PYX_ERR(0, 123, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
  }

  /* "fastgd/fastgd_faster.pyx":124
 *     for i in range(N-1):
 *         x_arr[i] = x[i]
 *     return x_arr             # <<<<<<<<<<<<<<
 * 
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "fastgd.fastgd_faster.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "fastgd.fastgd_faster.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "fastgd.fastgd_faster.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "fastgd.fastgd_faster._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec_fastgd_faster(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_fastgd_faster},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_fastgd_fastgd_faster, __pyx_k_fastgd_fastgd_faster, sizeof(__pyx_k_fastgd_fastgd_faster), 0, 0, 1, 1},
  {&__pyx_kp_s_fastgd_fastgd_faster_pyx, __pyx_k_fastgd_fastgd_faster_pyx, sizeof(__pyx_k_fastgd_fastgd_faster_pyx), 0, 0, 1, 0},
 ...
 *     # Initialization of the GD algorithm
 */
  __pyx_tuple__21 = PyTuple_Pack(12, __pyx_n_s_inc_mat, __pyx_n_s_N, __pyx_n_s_r_lb, __pyx_n_s_r_ub, __pyx_n_s_gamma, __pyx_n_s_max_iter, __pyx_n_s_verbose, __pyx_n_s_tol, __pyx_n_s_inc_mat_tr, __pyx_n_s_x, __pyx_n_s_x_arr, __pyx_n_s_i); if (unlikely(!__pyx_tuple__21)) __PYX_ERR(0, 114, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__21);
  __Pyx_GIVEREF(__pyx_tuple__21);
  __pyx_codeobj__22 = (PyObject*)__Pyx_PyCode_New(8, 0, 12, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__21, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_fastgd_fastgd_faster_pyx, __pyx_n_s_gd, 114, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__22)) __PYX_ERR(0, 114, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initfastgd_faster(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initfastgd_faster(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_fastgd_faster(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_fastgd_faster(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_fastgd_faster(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'fastgd_faster' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_fastgd_faster(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("fastgd_faster", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_fastgd__fastgd_faster) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "fastgd.fastgd_faster")) {
      if (unlikely(PyDict_SetItemString(modules, "fastgd.fastgd_faster", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_sparse, __pyx_t_1) < 0) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "fastgd/fastgd_faster.pyx":16
 * from scipy import sparse
 * 
 * np.import_array()             # <<<<<<<<<<<<<<
 * 
 ...
 *     # Initialization of the GD algorithm
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_6fastgd_13fastgd_faster_1gd, NULL, __pyx_n_s_fastgd_fastgd_faster); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 114, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_gd, __pyx_t_2) < 0) __PYX_ERR(0, 114, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "fastgd/fastgd_faster.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init fastgd.fastgd_faster", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init fastgd.fastgd_faster");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
