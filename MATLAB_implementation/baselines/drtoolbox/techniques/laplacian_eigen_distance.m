function [mappedX, mapping] = laplacian_eigen_distance(G, no_dims, k, sigma, eig_impl)
%LAPLACIAN_EIGEN Performs non-linear dimensionality reduction using Laplacian Eigenmaps
%
%   [mappedX, mapping] = laplacian_eigen(G, no_dims, k, sigma, eig_impl)
%
% Performs non-linear dimensionality reduction using Laplacian Eigenmaps.
% The G is the distance matrix. The variable dim indicates the preferred amount
...
%
% Modification of laplacian_eigen to work on distance instead of original
% data.
